  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto px-9 py-7 space-y-6">
        ...
        {/* 終評 · AI 採購情報中心 — 已搬到管理後台（/erp/admin/cost-intelligence）
            外部公開頁不再顯示 SaaS 賣點視角，避免內部分數外洩。 */}
...
// 終評 · AI 採購情報中心 (AI Cost Intelligence Center) 已移至
//   src/components/erp/CostIntelligenceCenterCard.tsx
// 並只在管理後台 /erp/admin/cost-intelligence 顯示。
